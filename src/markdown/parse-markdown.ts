...
export function parseInlineMarkdown(line: string): InlineSpan[] {
...
export function parseAgentMarkdown(content: string): MarkdownBlock[] {
  ...
  while (index < lines.length) {
    ...
    blocks.push({
      type: "paragraph",
      lines: paragraphLines.map((paragraphLine) =>
